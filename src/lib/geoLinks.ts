/**
 * Geographic proximity linking engine for Hérault (34).
...
export function getNearbyCommunes(
  ...
  return allCommunes
    ...
    .map(c => {
      ...
      // Approximate physical distance in km using local projection (43.6°N for Hérault)
      // 1 degree of Latitude ≈ 111.1 km
      // 1 degree of Longitude ≈ 111.1 * cos(43.6°) ≈ 80.5 km
      const dLat = (lat - currentLat) * 111.1;
      const dLon = (lon - currentLon) * 80.5;
